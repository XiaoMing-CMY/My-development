...
public class text14 {
    public static void main(String[] args) {
        ...
        if(redCount==6&&blueCount==1){
            System.out.println("恭喜您！中1000万！");
        }else if(redCount==6&&blueCount==0){
            System.out.println("恭喜您！中500万！");
        }else if(redCount==5&&blueCount==1){
            System.out.println("恭喜您！中3000元！");
        }else if((redCount==5&&blueCount==0)||(redCount==4&&blueCount==1)){
            System.out.println("恭喜您！中200元");
        }else if((redCount==4&&blueCount==0)||(redCount==3&&blueCount==1)){
            System.out.println("恭喜您！中10元");
        }else if((redCount==3&&blueCount==0)||(redCount==2&&blueCount==1)){
            System.out.println("恭喜您！中5元");
